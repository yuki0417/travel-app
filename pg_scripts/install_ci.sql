CREATE ROLE travel_ci WITH LOGIN PASSWORD 'travel_ci';
CREATE DATABASE djangodb_ci WITH TEMPLATE = template0 OWNER = travel_ci ENCODING = 'UTF8' LC_COLLATE = 'ja_JP.UTF-8' LC_CTYPE = 'ja_JP.UTF-8';
\connect djangodb_ci
CREATE SCHEMA IF NOT EXISTS django_ci;
GRANT ALL PRIVILEGES on database djangodb_ci to travel_ci;
